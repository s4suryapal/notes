import { View, Text, StyleSheet, TouchableOpacity, Modal, Pressable, Alert, Share as RNShare, ScrollView, Clipboard, ActivityIndicator, NativeModules } from 'react-native';
